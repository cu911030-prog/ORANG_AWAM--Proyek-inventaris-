...
<div class="container py-5">
    <div class="row">
                ...
                <div class="card-body">
                    <form action="{{ route('kategori.store') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_kategori') is-invalid @enderror" id="nama_kategori" name="nama_kategori" value="{{ old('nama_kategori') }}" required placeholder="Contoh: Elektronik">
                            @error('nama_kategori')
        ...
        <div class="col-md-8">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white fw-bold border-0 pt-3">Daftar Kategori Barang</div>
                <div class="card-body">
                    @if(session('success'))
                            ...
                            <tbody>
                                @forelse($kategoris as $index => $kategori)
                                    <tr>
                                        ...
                                        <td><code class="text-muted">{{ $kategori->slug }}</code></td>
